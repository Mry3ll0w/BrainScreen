...
class MyDataTable extends StatelessWidget //__
{
  ...
  Widget build(context) //__
  {
    return DataTable(
      ...
      columns: const [
        DataColumn(
            label: Text('ID', style: ButtonGrid.contentStyleHeader),
            numeric: true),
        DataColumn(
            label: Text('Description', style: ButtonGrid.contentStyleHeader)),
        DataColumn(
            label: Text('Price', style: ButtonGrid.contentStyleHeader),
            numeric: true),
      ],
      rows: const [
        DataRow(
          cells: [
            DataCell(Text('1',
                style: ButtonGrid.contentStyle, textAlign: TextAlign.right)),
            DataCell(Text('Fancy Product', style: ButtonGrid.contentStyle)),
        ...
        DataRow(
          cells: [
            DataCell(Text('2',
                style: ButtonGrid.contentStyle, textAlign: TextAlign.right)),
            DataCell(Text('Another Product', style: ButtonGrid.contentStyle)),
        ...
        DataRow(
          cells: [
            DataCell(Text('3',
                style: ButtonGrid.contentStyle, textAlign: TextAlign.right)),
            DataCell(Text('Really Cool Stuff', style: ButtonGrid.contentStyle)),
        ...
        DataRow(
          cells: [
            DataCell(Text('4',
                style: ButtonGrid.contentStyle, textAlign: TextAlign.right)),
            DataCell(
                Text('Last Product goes here', style: ButtonGrid.contentStyle)),
    ...
    return Accordion(
      ...
      children: [
        AccordionSection(
          ...
          headerBackgroundColorOpened: Colors.black54,
          header:
              const Text('Nested Section #1', style: ButtonGrid.headerStyle),
          content:
              const Text(ButtonGrid.loremIpsum, style: ButtonGrid.contentStyle),
          contentHorizontalPadding: 20,
          contentBorderColor: Colors.black54,
        ),
        AccordionSection(
          ...
          header:
              const Text('Nested Section #2', style: ButtonGrid.headerStyle),
          headerBackgroundColor: Colors.black38,
          headerBackgroundColorOpened: Colors.black54,
          contentBorderColor: Colors.black54,
          content: const Row(
            children: [
              ...
              Flexible(
                  flex: 1,
                  child: Text(ButtonGrid.loremIpsum,
                      style: ButtonGrid.contentStyle)),
            ],
          ),
        ),
      ],
